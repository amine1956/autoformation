				...
				<div class="row">
					...
					<div class="col-xs-11 text-right menu-1">
						<ul>
							...
							<li class="btn-cta1"><a href="inscription.php"><span>Inscription</span></a></li>
						</ul>
					</div>
				</div>
				...
				<div class="col-md-6 animate-box">
					...
					<form method="post" >
						...
						<div class=" row form-group">
                            ...
                            <div>
							<input name="ok" type="submit" value="Connexion" class="btn btn-primary" >
                                </div>
						</div>
