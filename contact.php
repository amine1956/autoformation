...
$sql= "INSERT INTO messages VALUES ('',$idetu,'$dt','$objet','$message')";       
mysqli_query($con,$sql);
            
            header("Location: http://127.0.0.1/learn/index.php?con=oui");
}
?>
<html>
	<head>
			...
			<div class="row">
				<div class="col-md-5 col-md-push-1 animate-box">
					...
					<div class="fh5co-contact-info">
						<h3>Des information
                            <br/>pour nous contacter</h3>
						<ul>
							<li class="address">Boulevard Hassan II,<br> Mohammédia 28830 </li>
							<li class="phone"><a href="tel://1234567920">+ 212 684100914 </a></li>
							<li class="email"><a href="mailto:elasriasmaa@gmail.com">contacter nous </a></li>
					...
					<form action="#" method="post">
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input name="objet" type="text" id="subject" class="form-control" placeholder="Your subject of this message" required>
							</div>
						</div>
						...
						<div class="form-group">
							<input name="ok" type="submit" value="Enoyer le Message" class="btn btn-primary">
						</div>
